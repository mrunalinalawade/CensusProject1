...
const Bankaddedsuccessfully = (props) => {
    return (
            ...
            <View style={{ flex: 1 }}>
                ...
                <Header   navigate={() => props.navigation.goBack()}/>
                    <View style={styles.inputStyle}>
                        ...
                        <Text style={styles.account}>Bank added successfully</Text>
                        {/* <Text style={[styles.account,{fontSize:14,marginTop:'3%'}]}>Your password change successfully</Text> */}
                    </View>

                   
                    <WholeButton1 Label={'Okay, Thank you'} Action={() => props.navigation.navigate('Login')} styles={{ width: width * 0.9, marginTop:height*0.46 }} />
                </View>
            </View>
        </SafeAreaView>
    )
